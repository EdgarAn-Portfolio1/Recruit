...
public class DownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(
		...
		FreeBoardAttachVO attachment = (FreeBoardAttachVO)params.get("attachment");
		...
		String file2 = application.getRealPath("/resources/upload-files-free/" + attachment.getSavedFileName());

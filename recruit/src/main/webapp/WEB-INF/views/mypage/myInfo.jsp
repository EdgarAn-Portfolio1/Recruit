					...
					<div class="card">
						<div class="card-body">
							<div class="form-validation">
								<form id="write-MyInfo-form"  action="myInfo_edit" method="post">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" name="year" placeholder="나이을 입력하세요...">
										</div>
									</div>
									...
									<div class="form-group row">
									 ...
									 <!-- 학력 -->
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="degree">학력
											 <span class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<select class="form-control" id="wish_site" name="wish_site">
												<option value="">선택해 주세요.</option>
...
<script type="text/javascript">
	$(function() {
		...
		$("#write-button").on("click", function(event){
			...
			var yes = confirm("내 정보를 등록하시겠습니까?");
			if (yes) {
				$("#write-MyInfo-form").submit()
			}
		})
	});
</script>
